...
resid(fit_m5) 
rmsea(fit_m5)
str(as.list(fitMeasures(fit_m5)))
parTable(fit_m5)
...
stooges <- list(Person("moe", 40), Person("larry", 50), Person("curly", 60))
# pluck names for a list of listy objects
the_names <- sapply(stooges, pluck("name"))
the_ages <- sapply(stooges, pluck("age"))
pluck("age")(stooges[[1]])
stooges2 <- Map(Person, the_names, the_ages)
# zip them together
Map(c, the_names, the_ages)
